    ...
    <div class="col-md-4 col-12">
      <div class="card">
        <div class="card-header">
          <h4 class="card-title">Cadastrar Nova Ocupação</h4>
        </div>
        <div class="card-body">
          <form class="form form-horizontal" method="POST" action="{{ route('ocupacoes.store') }}">
            @csrf()
            <div class="row">
              <div class="col-12">
                <div class="mb-1 row">
                  ...
                  <div class="col-sm-9">
                    <input type="text" id="title" class="form-control" name="title" placeholder="Nome do ocupação" />
                  </div>
                </div>
              </div>
              <div class="col-12">
                  ...
                  <div class="col-sm-9">
                    <select class="select2 form-select" id="departament_id" name="departament_id">
                      @foreach($departaments as $departament)
                          <option value="{{ $departament->id }}" >{{ $departament->sigla }} - {{ $departament->departament }}</option>
                      @endforeach
                    </select>
                  </div>
                </div>
