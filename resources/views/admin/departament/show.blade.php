    ...
    <div class="col-md-4 col-12">
      <div class="card">
        <div class="card-header">
          <h4 class="card-title">Dados do Departamento</h4>
        </div>
        <div class="card-body">
          <form class="form form-horizontal" method="POST" action="{{ route('departamentos.update', $departament_selected->id) }}">
            @csrf()
            @method('PUT')
            <div class="row">
              <div class="col-12">
                <div class="mb-1 row">
                  ...
                  <div class="col-sm-9">
                    <input type="text" value="{{ $departament_selected->departament }}" id="departament" class="form-control" name="departament" placeholder="Nome do Departamento" />
                  </div>
                </div>
              </div>
              <div class="col-12">
                <div class="mb-1 row">
                  ...
                  <div class="col-sm-9">
                    <input type="text" value="{{ $departament_selected->sigla }}" id="sigla" class="form-control" name="sigla" placeholder="sigla" />
                  </div>
                </div>
              </div>
              <div class="col-12">
                <div class="mb-1 row">
                  ...
                  <div class="col-sm-9">
                    <input type="text" value="{{ $departament_selected->code }}" id="code" class="form-control" name="code" placeholder="registro" />
                  </div>
                </div>
              </div>
              <div class="col-12">
                <div class="mb-1 row">
                  ...
                  <div class="col-sm-9">
                    <select class="select2 form-select" id="unit_id" name="unit_id">
                      @foreach($units as $unit)
                          <option value="{{ $unit->id }}"  {{ $unit->id === $departament_selected->unit ? 'selected' : '' }}>{{ $unit->sigla }} - {{ $unit->name }}</option>
                      @endforeach
                    </select>
                  </div>
                </div>
              ...
              <div class="col-12">
                <div class="mb-1 row">
                  ...
                  <div class="col-sm-9">
                    <input type="text" value="{{ $departament_selected->phone }}" id="phone" class="form-control" name="phone" placeholder="22 999 9999" />
                  </div>
                </div>
              </div>
              <div class="col-12">
                <div class="mb-1 row">
                  ...
                  <div class="col-sm-9">
                    <input type="text" value="{{ $departament_selected->email }}" id="email" class="form-control" name="email" placeholder="e-mail" />
                  </div>
                </div>
              </div>
              <div class="col-12">
                <div class="mb-1 row">
                  ...
                  <div class="col-sm-9">
                    <input type="text" value="{{ $departament_selected->responsible }}" id="responsible" class="form-control" name="responsible" placeholder="responsável" />
                  </div>
                </div>
              </div>
              <div class="col-sm-9 offset-sm-3">
                ...
                <form method="POST" name="form-delete" action="{{ route('departamentos.destroy', $departament_selected->id) }}">
                    @csrf()
                    @method('delete')
                    <button type="submit" class="btn btn-danger" style="position: relative; float: left;" 
                      onclick="return confirm('Tem certeza que deseja deletar o departamento?');">Deletar
                    </button>
                </form>
              </div>
            </div>
