...
class PagesController extends Controller
{
    ...
    public function account_settings_account()
    {
        ...
        return view('/admin/account/page-account-settings-account', ['breadcrumbs' => $breadcrumbs]);
    }
    ...
    public function account_settings_security()
    {
        ...
        return view('/admin/account/page-account-settings-security', ['breadcrumbs' => $breadcrumbs]);
    }
    ...
    public function account_settings_billing()
    {
        ...
        return view('/admin/account/page-account-settings-billing', ['breadcrumbs' => $breadcrumbs]);
    }
    ...
    public function account_settings_notifications()
    {
        ...
        return view('/admin/account/page-account-settings-notifications', ['breadcrumbs' => $breadcrumbs]);
    }
    ...
    public function account_settings_connections()
    {
        ...
        return view('/admin/account/page-account-settings-connections', ['breadcrumbs' => $breadcrumbs]);
    }
