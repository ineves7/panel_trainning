...
/* Route Components */
Route::group(['middleware' => ['auth'], 'prefix' => 'component'], function () {
...
/* Route Extensions */
Route::group(['middleware' => ['auth'], 'prefix' => 'ext-component'], function () {
...
/* Route Page Layouts */
Route::group(['middleware' => ['auth'], 'prefix' => 'page-layouts'], function () {
...
/* Route Tables */
Route::group(['middleware' => ['auth'], 'prefix' => 'table'], function () {
...
Route::group([ 'prefix' => 'auth'], function () {
    ...
    //Route::get('register', [AuthenticationController::class, 'register'])->middleware(['auth'])->name('auth-register');
    Route::get('lock-screen', [AuthenticationController::class, 'lock_screen'])->name('auth-lock_screen');
});
/* Route Authentication Pages */

/* Route Charts */
Route::group(['middleware' => ['auth'], 'prefix' => 'chart'], function () {
...
Route::resource('/cadastrocaneca', MugController::class);
